...
Presets start collapsed. Installation offers an optional preset adjustment before continuing.
...
preset controls, Settings, Progress and Done. Cancellation-boundary tests verify
that the UI stops offering cancellation before the final undo decision.
